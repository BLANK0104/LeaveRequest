...
class GatekeeperActivity : AppCompatActivity() {
    ...
    private fun displayLeaveRequests(leaveRequests: List<LeaveRequest>) {
        ...
        for (leaveRequest in leaveRequests) {
            if (leaveRequest.gatekeeper_status != "Pending" && leaveRequest.warden_status != "Approved" && leaveRequest.hod_status != "Approved" && leaveRequest.faculty_status == "Approved") continue
